      ...
      <div className="h-full overflow-y-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-600">
            Subscribe now for unlimited access to Hotelier Africa Magazine
          </p>
        </div>
            ...
            <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:border-gray-300 transition-colors">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Unlimited access to Hotelier Africa Magazine</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-brand-blue pl-4">
              <p className="text-gray-700 italic">"Hotelier Africa Magazine provides the most comprehensive coverage of finance and investment insights in the GCC region. Worth every penny!"</p>
